...
export default class Login extends Component {
  ...
  componentWillReceiveProps(nextProps){
    const self = this
    if(this.props.loginResponse.data != nextProps.loginResponse.data){
      this.setState({loading: false})
      if(nextProps.loginResponse.data.status == 1){
        ...
        sessionStorage.setItem('divisionid', nextProps.loginResponse.data.data.usertable.gxdwdm)
        hashHistory.push('/')
      }
    }
  }
      ...
      <div className="login">
          ...
          <div className="btmLogin">
            <div className="sy_bottom">
              <h1 id="PerformName">宿迁公安基础警务平台</h1>
                  ...
                  <Spin spinning={this.state.loading}>
                    <Form inline onSubmit={this.handleSubmit}>
                      ...
                      <FormItem>
                        ...
                        <Button type="primary" className="hide">证书</Button>
                      </FormItem>
                    </Form>
                  </Spin>
                </Col>
